...
![](https://catedu.gitbooks.io/atrevete-con-wordpress/content/assets/hosting10-acceder-listado-sitios-web.png)

Clic en “Administrar sitio web”

![](https://catedu.gitbooks.io/atrevete-con-wordpress/content/assets/hosting11-admin-sitio-web.png)

Clic en “Administrar bases de datos”

![](https://catedu.gitbooks.io/atrevete-con-wordpress/content/assets/hosting12-acceso-bd.png)

Clic en “Nueva Base de Datos”

![](https://catedu.gitbooks.io/atrevete-con-wordpress/content/assets/hosting13-nueva-bd.png)
...
![](https://catedu.gitbooks.io/atrevete-con-wordpress/content/assets/hosting14-crear-bd.png)
...
![](https://catedu.gitbooks.io/atrevete-con-wordpress/content/assets/hosting14bis-datos-bd-reales.png)
...
![](https://catedu.gitbooks.io/atrevete-con-wordpress/content/assets/hosting15-descargaWP.png)
...
![](https://catedu.gitbooks.io/atrevete-con-wordpress/content/assets/hosting16-descomprimir.png)
...
![](https://catedu.gitbooks.io/atrevete-con-wordpress/content/assets/hosting17-acceso-archivos.png)
...
![](https://catedu.gitbooks.io/atrevete-con-wordpress/content/assets/hosting18-uploadfile.png)
...
![](https://catedu.gitbooks.io/atrevete-con-wordpress/content/assets/hosting19-descomprimir.png)
...
![](https://catedu.gitbooks.io/atrevete-con-wordpress/content/assets/hosting20-mover.png)
...
![](https://catedu.gitbooks.io/atrevete-con-wordpress/content/assets/hosting21-cambiar carpeta destino.png)

![](https://catedu.gitbooks.io/atrevete-con-wordpress/content/assets/hosting22-cambiar-carpeta.png)

![](https://catedu.gitbooks.io/atrevete-con-wordpress/content/assets/hosting23-carpeta-public_html.png)
...
![](https://catedu.gitbooks.io/atrevete-con-wordpress/content/assets/hosting25-delete.png)
...
![](https://catedu.gitbooks.io/atrevete-con-wordpress/content/assets/hosting26-rename.png)

![](https://catedu.gitbooks.io/atrevete-con-wordpress/content/assets/hosting27-rename2.png)

Clic en wp-config.php con el “botón derecho del ratón – Edit”

![](https://catedu.gitbooks.io/atrevete-con-wordpress/content/assets/hosting28-edit.png)
...
![](https://catedu.gitbooks.io/atrevete-con-wordpress/content/assets/hosting29-instalar-wp.png)
